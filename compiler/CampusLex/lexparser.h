...
{
  //contexte métier
  char             sNomSourceFich[64];
  FILE*            pSourceFile;
  UINT             numLigne;
  UINT             numColonne;
  AUTOWORD 	       longSymboleCourant;       // Longuer courant du symbole en cours d'accumulation
  char             sLibSymboleCourant[MAX_LONG_SYMBOLE];       // buffeur d'accumulation du symb
  AUTOWORD 	       vNbSymbole;						 //	Nombre de symboles courant
